...
<div class="caption">
    Greenspace connectivity, tick population size, and deer occupancy for white-tailed deer (figure from Lilly et al. (2025))
</div>

We are currently developing continuous hazard maps along the urban gradient by integrating landscape and weather covariates to interpolate across unsampled areas. In parallel, we are refining connectivity estimates using high-resolution GPS data collected from deer on Staten Island.
